...
$e_cabang = balikin($rowx['cabang']);




//nilai
$filenya = "dari_cabang.php";
$judul = "Memo dari Cabang : $e_cabang";
$judul = "[HISTORY]. Memo dari Cabang : $e_cabang";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM info_dari_cabang ".
