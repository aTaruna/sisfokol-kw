          ...
          <div class="col-md-4">
            ...
            <div class="card">
                  ...
                  <table class="table m-0">
                    ...
                    <?php
                    	do 
							...
							$i_filex = "$i_kd.png";
							$nil_foto = "$sumber/filebox/foto/$sekkd85_session/$i_kd/$i_filex";
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admsekkpeg/h/foto_sekolah.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              ...
              <!-- /.card-body -->
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admsekkpeg/h/youtube_sekolah.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              ...
              <!-- /.card-body -->
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admsekkpeg/kpeg/lap_pensiun.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
