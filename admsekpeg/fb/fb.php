...
if($_POST['btnHPS'])
	...
	for ($i=1; $i<=$limit;$i++)
		...
		//hapus file 
		$filex_namex2 = "$kd.pdf";
		$path1 = "../../filebox/arsip/$kd82_session/$kd/$filex_namex2";
		chmod($path1,0777);
		unlink ($path1);
		}
...
if ($s == "baru")
	...
	$path1 = "../../filebox/arsip/$kd82_session";
	...
	//bikin folder, jika belum ada
	$path2 = "../../filebox/arsip/$kd82_session/$kd";
	...
	<form id="upload-form" class="upload-form" method="post">
	     <div class="row align-items-center">
	      <div class="form-group col-md-8">
				...
				<p>
					<input name="pegkd" id="pegkd" type="hidden" value="<?php echo $kd82_session;?>">
	...
	if ($count != 0)
		...
		do 
			...
			<i>'.$i_ket.'</i>
			<br>
			<a href="../../filebox/arsip/'.$kd82_session.'/'.$i_kd.'/'.$i_kd.'.pdf" class="btn btn-danger" title="'.$i_judul.'" target="_blank">UNDUH</a>
			</td>
			<td>'.$i_postdate.'</td>
			</tr>';
			}
