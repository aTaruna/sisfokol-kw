...
//update cabang
mysqli_query($koneksi, "UPDATE sekolah_cp_youtube SET cabang = '$e_cabang' ".
...
if($_POST['btnSMP'])
	...
	if ((empty($e_judul)) OR (empty($e_filex)))
		...
		if ((empty($s)) OR ($s == "baru"))
			{
			//query
			mysqli_query($koneksi, "INSERT INTO sekolah_cp_youtube (kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
			...
			{
			//query
			mysqli_query($koneksi, "UPDATE sekolah_cp_youtube SET judul = '$e_judul', ".
										"filex = '$e_filex', ".
										"postdate = '$today' ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"AND kd = '$kdku'");
...
if($_POST['btnHPS'])
	...
	for ($i=1; $i<=$limit;$i++)
		...
		//del
		mysqli_query($koneksi, "DELETE FROM sekolah_cp_youtube ".
						"WHERE sekolah_kd = '$kd81_session' ".
						"AND kd = '$kd'");
		}
...
if (($s == 'baru') OR ($s == 'edit'))
	{
	//query
	$qx = mysqli_query($koneksi, "SELECT * FROM sekolah_cp_youtube ".
									"WHERE sekolah_kd = '$kd81_session' ".
									"AND kd = '$kdku'");
	$rowx = mysqli_fetch_assoc($qx);
