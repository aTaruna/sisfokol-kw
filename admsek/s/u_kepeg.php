...
//nilai
$filenya = "u_kepeg.php";
$judul = "User Kepegawaian";
$judul = "[SETTING]. User Kepegawaian";
$judulku = "$judul";
$judulx = $judul;
...
if ($_POST['btnSMP'])
	...
	if (empty($e_kode))
		...
		if (!empty($tku))
			{
			//update
			mysqli_query($koneksi, "UPDATE sekolah_pegawai SET user_kepeg = 'true', ".
										"postdate_user = '$today' ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"AND kd = '$ku_kd'");
...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysqli_query($koneksi, "UPDATE sekolah_pegawai SET user_kepeg = 'false' ".
									"WHERE sekolah_kd = '$kd81_session' ".
									"AND kd = '$kd'");
		}
