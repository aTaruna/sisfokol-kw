...
//ambil nilai
$sekkd = nosql($_REQUEST['sekkd']);
$kd = nosql($_REQUEST['kd']);



$foldernya = "../../filebox/artikel/$sekkd/";
			
//buat folder...
if (!file_exists('../../filebox/artikel/'.$sekkd.'')) {
    mkdir('../../filebox/artikel/'.$sekkd.'', 0777, true);
	}




$foldernya = "../../filebox/artikel/$sekkd/$kd";
			
//buat folder...
if (!file_exists('../../filebox/artikel/'.$sekkd.'/'.$kd.'')) {
    mkdir('../../filebox/artikel/'.$sekkd.'/'.$kd.'', 0777, true);
	}
...
//  if($size < (1024*1024))
  if($size < (5120*5120))
  {
   $new_image = '';
   $new_name = $namabaru;
   $path = "../../filebox/artikel/$sekkd/$kd/$new_name";
