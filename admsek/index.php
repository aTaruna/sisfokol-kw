        ...
        <div class="row">
          ...
          <div class="col-md-8">
			...
			for($i=0; $i<=14; $i++)
				...
				//ketahui ordernya...
				$qyuk = mysqli_query($koneksi, "SELECT SUM(nilai) AS harganya ".
													"FROM sekolah_uang_masuk ".
													"WHERE sekolah_kd = '$kd81_session' ".
													"AND round(DATE_FORMAT(per_tgl, '%d')) = '$itgl' ".
													"AND round(DATE_FORMAT(per_tgl, '%m')) = '$ibln' ".
													"AND round(DATE_FORMAT(per_tgl, '%Y')) = '$itahun'");
				$ryuk = mysqli_fetch_assoc($qyuk);
				$j_harga = balikin($ryuk['harganya']);
          ...
          <div class="col-md-4">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admsek/kpeg/lap_pensiun.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
