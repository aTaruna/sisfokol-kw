...
$e_cabang = cegah($cabang81_session);
...
if ($_POST['btnIMX'])
	...
	if (empty($filex_namex2))
		...
		if ($ext_filex == ".csv")
			...
			$filex_namex2 = "$kd81_session-kib-$katkd.csv";
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_ket = cegah(strip_tags($data[13]));
							  	$i_x1 = md5($i_kode);
								$i_xyz = "$kd81_session$i_x1";

							  
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_a(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_ket = cegah(strip_tags($data[17]));
								...
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_b(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_register = cegah(strip_tags($data[3]));
								...
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_c(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_register = cegah(strip_tags($data[3]));
								...
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_d(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_register = cegah(strip_tags($data[3]));
								...
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_e(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
				...
				if (($handle = fopen($uploadfile, "r")) !== FALSE) {
				    ...
				    while (($data = fgetcsv($handle, 10000, ";")) !== FALSE) {
						      ...
						      $i_register = cegah(strip_tags($data[3]));
								...
								//insert
								mysqli_query($koneksi, "INSERT INTO sekolah_kib_f(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
												"per_tahun, barang_kode, barang_nama, ".
			...
			$ku_ket = cegah("$judul. IMPORT DATA : KIB-$katkd");			
...
if ($_POST['btnEX'])
	...
	if ($katkd == "A")
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_a ".
	...
	//jika kib-B ///////////////////////////////////////////////////////////////////////////////////////
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_b ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"ORDER BY round(barang_kode) ASC");
		$rdt = mysqli_fetch_assoc($qdt);
	...
	//jika kib-C ///////////////////////////////////////////////////////////////////////////////////////
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_c ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"ORDER BY round(barang_kode) ASC");
		$rdt = mysqli_fetch_assoc($qdt);
	...
	//jika kib-D ///////////////////////////////////////////////////////////////////////////////////////
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_d ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"ORDER BY round(barang_kode) ASC");
		$rdt = mysqli_fetch_assoc($qdt);
	...
	//jika kib-E ///////////////////////////////////////////////////////////////////////////////////////
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_e ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"ORDER BY round(barang_kode) ASC");
		$rdt = mysqli_fetch_assoc($qdt);
	...
	//jika kib-F ///////////////////////////////////////////////////////////////////////////////////////
		...
		//data
		$qdt = mysqli_query($koneksi, "SELECT * FROM sekolah_kib_f ".
										"WHERE sekolah_kd = '$kd81_session' ".
										"ORDER BY round(barang_kode) ASC");
		$rdt = mysqli_fetch_assoc($qdt);
...
if ($_POST['btnHPS'])
	...
	if ($katkd == "A")
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_a ".
							"WHERE kd = '$kd'");
			}
		}
	...
	//jika kib-B
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_b ".
							"WHERE kd = '$kd'");
			}
		}
	...
	//jika kib-C
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_c ".
							"WHERE kd = '$kd'");
			}
		}
	...
	//jika kib-D
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_d ".
							"WHERE kd = '$kd'");
			}
		}
	...
	//jika kib-E
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_e ".
							"WHERE kd = '$kd'");
			}
		}
	...
	//jika kib-F
		...
		for ($i=1; $i<=$jml;$i++)
			...
			//del
			mysqli_query($koneksi, "DELETE FROM sekolah_kib_f ".
							"WHERE kd = '$kd'");
			}
		}
