...
if ($_POST['btnIMX'])
	...
	if (empty($filex_namex2))
		...
		if ($ext_filex == ".xls")
			...
			$filex_namex2 = "data_pegawai_majelis.xls";
			    ...
			    if ($i > 1) 
			    	{
					  ...
					  $i_passx = md5($i_akses);
						...
						//insert
						mysqli_query($koneksi, "INSERT INTO majelis_pegawai(kd, kode, nbm, nama, telp, email, alamat, ".
										...
										"('$i_xyz', '$i_kode', '$i_kode', '$i_nama', '$i_telp', '$i_email', '$i_alamat', ".
...
if ($_POST['btnEX'])
	...
	//nama file e...
	$i_filename = "data_pegawai_majelis.xls";
	$i_judul = "data_pegawai_majelis";
	...
	//data
	$qdt = mysqli_query($koneksi, "SELECT * FROM majelis_pegawai ".
									"ORDER BY nama ASC");
...
if ($s == "reset")
	...
	//update
	mysqli_query($koneksi, "UPDATE majelis_pegawai SET passwordx = '$passbarux' ".
					"WHERE kd = '$kd'"); 
...
if ($_POST['btnSMP'])
	...
	if ((empty($e_kode)) OR (empty($e_telp)) OR (empty($e_nama)))
		...
		if ($s == "baru")
			{
			//insert
			mysqli_query($koneksi, "INSERT INTO majelis_pegawai(kd, kode, nbm, nama, ".
							"alamat, telp, email, ".
							"jabatan, lahir_tmp, lahir_tgl, ".
							"bekerja_sejak_disini, bekerja_sejak_dimuh, ".
							"ijazah, ijazah_pddkn, mengajar, sertifikasi, ".
							"pensiun, pensiun_tgl, usernamex, passwordx, postdate) VALUES ".
							"('$kd', '$e_kode', '$e_kode', '$e_nama', ".
				...
				mysqli_query($koneksi, "INSERT INTO user(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
								...
								"('$kd', '$kd41_session', '$e_sekkode','$e_seknama', ".
								"'$kd', '$e_kode', '$e_nama', ".
								"'MAJELIS', 'PEGAWAI', '$today')");
		...
		if ($s == "edit")
			{
			mysqli_query($koneksi, "UPDATE majelis_pegawai SET kode = '$e_kode', ".
							"nbm = '$e_nbm', ".
							"nama = '$e_nama', ".
							"alamat = '$e_alamat', ".
							"telp = '$e_telp', ".
...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysqli_query($koneksi, "DELETE FROM majelis_pegawai ".
						"WHERE kd = '$kd'");
		}
...
//jika edit / baru
	...
	$qx = mysqli_query($koneksi, "SELECT * FROM majelis_pegawai ".
						"WHERE kd = '$kdx'");
	...
	if (empty($kunci))
		{
		$sqlcount = "SELECT * FROM majelis_pegawai ".
						"ORDER BY nama ASC";
		}
