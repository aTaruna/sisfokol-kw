...
//update
mysqli_query($koneksi, "UPDATE m_majelis SET lat_x = '$nilx', ".
				"lat_y = '$nily', ".
				"postdate = '$today'");
...
//jadikan alamat //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$qyuk = mysqli_query($koneksi, "SELECT * FROM m_majelis");
...
//update
mysqli_query($koneksi, "UPDATE m_majelis SET alamat_googlemap = '$nilaiku', ".
							"postdate = '$today'");
