...
//detail
$qku = mysqli_query($koneksi, "SELECT * FROM m_majelis");
...
?>
  ...
  <script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&&callback=initMap&key=<?php echo $keyku;?>"></script>
	...
	<?php
	//data di database
	$qdt = mysqli_query($koneksi, "SELECT * FROM m_majelis");
	...
	<input name="dataku" id="dataku" type="hidden" value="<?php echo $kd071_session;?>">
