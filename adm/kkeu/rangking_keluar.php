...
//nilai
$filenya = "rangking_keluar.php";
$judul = "Peringkat Uang Keluar";
$judul = "[KEUANGAN SEKOLAH]. Peringkat Uang Keluar";
$judulku = "$judul";
$judulx = $judul;
...
mysqli_query($koneksi, "DELETE FROM majelis_sekolah_uang_keluar");
...
do
	...
	//insert
	mysqli_query($koneksi, "INSERT INTO majelis_sekolah_uang_keluar(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_uang_keluar ".
...
//ketahui totalnya
$qyuk = mysqli_query($koneksi, "SELECT * FROM majelis_sekolah_uang_keluar");
$ryuk = mysqli_fetch_assoc($qyuk);
