...
//nilai
$filenya = "rangking_masuk.php";
$judul = "Peringkat Uang Masuk";
$judul = "[KEUANGAN SEKOLAH]. Peringkat Uang Masuk";
$judulku = "$judul";
$judulx = $judul;
...
mysqli_query($koneksi, "DELETE FROM majelis_sekolah_uang_masuk");
...
do
	...
	//insert
	mysqli_query($koneksi, "INSERT INTO majelis_sekolah_uang_masuk(kd, sekolah_kd, sekolah_kode, sekolah_nama, ".
								"tahun, total, postdate) VALUES ".
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_uang_masuk ".
...
//ketahui totalnya
$qyuk = mysqli_query($koneksi, "SELECT * FROM majelis_sekolah_uang_masuk");
$ryuk = mysqli_fetch_assoc($qyuk);
