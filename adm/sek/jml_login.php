...
//nilai
$filenya = "jml_login.php";
$judul = "Per Jumlah Login";
$judul = "[PROFIL SEKOLAH]. Per Jumlah Login";
$judulku = "$judul";
$judulx = $judul;
...
do
	...
	//ketahui totalnya
	$qyuk = mysqli_query($koneksi, "SELECT kd FROM user_log_login ".
	...
	//update
	mysqli_query($koneksi, "UPDATE m_sekolah SET total_login = '$jml_login' ".
								"WHERE kd = '$ku_kd'");
	}
...
if (empty($kunci))
	...
	$sqlcount = "SELECT * FROM m_sekolah ".
					"ORDER BY round(total_login) DESC";
	}
...
if ($count != 0)
	...
	do 
		...
		$i_total = balikin($data['total_login']);
