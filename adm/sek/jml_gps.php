...
//nilai
$filenya = "jml_gps.php";
$judul = "Per Jumlah GPS";
$judul = "[PROFIL SEKOLAH]. Per Jumlah GPS";
$judulku = "$judul";
$judulx = $judul;
...
do
	...
	//ketahui totalnya
	$qyuk = mysqli_query($koneksi, "SELECT kd FROM user_log_gps ".
	...
	//update
	mysqli_query($koneksi, "UPDATE m_sekolah SET total_gps = '$jml_login' ".
								"WHERE kd = '$ku_kd'");
	}
...
if ($count != 0)
	...
	do 
		...
		$i_total = balikin($data['total_gps']);
