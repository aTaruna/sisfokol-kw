...
//nilai
$filenya = "jml_siswa.php";
$judul = "Per Jumlah Siswa";
$judul = "[PROFIL SEKOLAH]. Per Jumlah Siswa";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	...
	$sqlcount = "SELECT * FROM m_sekolah ".
					"ORDER BY round(total_siswa) DESC";
	}
...
if ($count != 0)
	...
	do 
		...
		$i_total = balikin($data['total_siswa']);
