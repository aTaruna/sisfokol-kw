...
require("../../inc/cek/admcab.php");
require("../../inc/class/paging.php");
$tpl = LoadTpl("../../template/admcab.html");
...
$filenya = "pegawai.php";
$judul = "Data Pegawai";
$judul = "[PROFIL SEKOLAH]. Data Pegawai";
$judulku = "$judul";
$judulx = $judul;
...
//detail 
$qx = mysqli_query($koneksi, "SELECT * FROM m_cabang ".
				"WHERE kd = '$kd41_session'");
$rowx = mysqli_fetch_assoc($qx);
$e_kode = cegah($rowx['kode']);
$e_nama = cegah($rowx['nama']);
$e_cabang = cegah($rowx['nama']);
...
<td><strong><font color="'.$warnatext.'">TAHUN BEKERJA DI MUHAMMADIYAH</font></strong></td>
