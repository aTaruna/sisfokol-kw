...
//nilai
$filenya = "rangking_kib_c.php";
$judul = "Peringkat K.I.B-C [GEDUNG DAN BANGUNAN]";
$judul = "[SARPRAS SEKOLAH]. Peringkat K.I.B-C [GEDUNG DAN BANGUNAN]";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_kib_c ".
...
<td align="center" width="200"><strong><font color="'.$warnatext.'">LUAS LANTAI M2</font></strong></td>
<td align="center" width="200"><strong><font color="'.$warnatext.'">LUAS TANAH M2</font></strong></td>
...
if ($count != 0)
	...
	do 
		...
		$i_luas_tanah = balikin($data['luas_tanah']);
		...
		<td align="right">'.$i_luas_tanah.' M2</td>
