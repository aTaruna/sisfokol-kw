...
//nilai
$filenya = "rangking_kib_b.php";
$judul = "Peringkat K.I.B-B [PERALATAN DAN MESIN]";
$judul = "[SARPRAS SEKOLAH]. Peringkat K.I.B-B [PERALATAN DAN MESIN]";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_kib_b ".
