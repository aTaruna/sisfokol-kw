...
//nilai
$filenya = "rangking_kib_e.php";
$judul = "Peringkat K.I.B-E [ASET TETAP LAINNYA]";
$judul = "[SARPRAS SEKOLAH]. Peringkat K.I.B-E [ASET TETAP LAINNYA]";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_kib_e ".
