...
//nilai
$filenya = "rangking_kib_f.php";
$judul = "Peringkat K.I.B-F [KONTRUKSI DALAM PENYELESAIAN]";
$judul = "[SARPRAS SEKOLAH]. Peringkat K.I.B-F [KONTRUKSI DALAM PENYELESAIAN]";
$judulku = "$judul";
$judulx = $judul;
...
if (empty($kunci))
	{
	$sqlcount = "SELECT * FROM majelis_sekolah_kib_f ".
