...
//nilai
$filenya = "forum.php";
$judul = "[FORUM]. Topik Forum dari MAJELIS";
$judulku = "[FORUM]. Topik Forum dari MAJELIS";
$judulx = $judul;
...
if($_POST['btnSMP'])
	...
	//detail pengirim
	$ukd = $kd072_session;
	$ukode = $nip072_session;
	$unama = $xseknama072_session;
	$uket = $nm072_session;
	$ukat = "MAJELIS";
	$upos = "PEGAWAI";
...
if (empty($fkd))
	...
	if ($count != 0)
		...
		do
			...
			<a href="'.$filenya.'?fkd='.$i_kd.'" class="btn btn-block btn-danger">BERI KOMENTAR >></a>
			</td>
			</tr>';
			}
