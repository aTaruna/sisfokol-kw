    ...
    <div class="info-box mb-3 bg-warning">
      ...
      <div class="info-box-content">
        <span class="info-box-number">
			...
			<span class="info-box-text"><i>'.$f_kode.'</i></span>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            echo '<div class="callout callout-info">
                  <h5>INFO DARI YAYASAN MASJID AL-IMAN</h5>
                  <hr>';
          ...
          <div class="col-md-4">
			...
			<?php
			$limit = 5;
			$sqlcount = "SELECT * FROM majelis_cp_foto ".
							"ORDER BY postdate DESC";
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">FOTO DARI MAJELIS</h3>
                  ...
                  <table class="table m-0">
                    ...
                    <?php
                    	do 
							...
							$i_filex = "$i_kd.png";
							$nil_foto = "$sumber/filebox/foto/majelis/$i_kd/$i_filex";
              ...
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admmajpeg/h/foto_majelis.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
			...
			<?php
			$limit = 5;
			$sqlcount = "SELECT * FROM majelis_cp_youtube ".
							"ORDER BY postdate DESC";
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">LINK YOUTUBE DARI MAJELIS</h3>
              ...
              <!-- /.card-body -->
              <div class="card-footer clearfix">
                <a href="<?php echo $sumber;?>/admmajpeg/h/youtube_majelis.php" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
