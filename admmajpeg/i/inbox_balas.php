...
if($_POST['btnSMP'])
	...
	//detail pengirim
	$ukat = "MAJELIS";
	$ucab = $cabang072_session;
	$ucabkd = $cabang072_session;
	$usek = $xseknama072_session;
	$usekkd = $sekkd072_session;
	$ukd = $kd072_session;
...
$qyuk = mysqli_query($koneksi, "SELECT * FROM user_msg ".
									...
									"AND user_sekolah_kd = '$sekkd072_session' ".
									"AND user_posisi = 'PEGAWAI'");
